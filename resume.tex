...
\begin{itemize*}
  \item \emph{Security Engineer} (Jun. 2018 to present)\\
    ...
    \item Developed tools for pentesting Thrift applications
...
\textbf{Skills}
\begin{itemize*}
  \item Expertise with Java, Python, Go, App Engine, Datastore, MySQL, Thrift, HTML5, and Android SDK
  ...
  \item Experience locating/exploiting vulnerabilities like XSS, CSRF, SQLI, XXE, SSRF, RCE, XSHW, weak crypto
\end{itemize*}
\textbf{Code Sample}
\begin{itemize}
